...
public class SogCLI {
	...
	private static final String SOG = "http://localhost:8080/mbwar/rs/sog";
	...
	public static void main(String[] args) {
		...
		while (running) {
			...
			try {
				...
				} else if (CLI.match("invoke", args, 0)) {
					Invocation invocation = client.target(SOG).request().buildGet();
